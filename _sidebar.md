...
* **Bug Bounty Checklist**
  * **Reconnaissance**
    ...
    * [Parameter Discovery Checklist](./bug-bounty/recon/3-PARAMETERS.md)
  ...
  * **Attack**
    ...
    * [XSS General Checklist](./bug-bounty/attack/client/xss/XSS-GENERAL.md)
    * [XSS Path Segment Checklist](./bug-bounty/attack/client/xss/XSS-PATH-SEGMENT.md)
    * [XSS Referer Header Checklist](./bug-bounty/attack/client/xss/XSS-REFERER-HEADER.md)
    ...
    * **Server Side Attacks**
    * [OS Command InjectionChecklist](./bug-bounty/attack/server/COMMAND-INJECTION.md)
